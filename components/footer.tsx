    ...
    <footer className="bg-gray-900 text-gray-200">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-white">Tripsathi</span>
            </Link>
            <p className="mt-4 text-gray-400">
              Your all-in-one travel companion for booking flights, hotels, cabs, and creating personalized itineraries.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/cabs" className="text-gray-400 hover:text-white">
                  Cab Booking
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-400">support@tripsathi.com</span>
              </li>
              <li className="flex items-start space-x-2">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-center text-gray-400">&copy; {new Date().getFullYear()} Tripsathi. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
